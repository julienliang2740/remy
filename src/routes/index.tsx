...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Sous — Your AI kitchen co-pilot" },
      {
        name: "description",
        content:
          "Sous is a calm AI coach for everyday cooking — suggests recipes from what you have, guides you live with your camera, and helps you spend less on groceries.",
      },
      { property: "og:title", content: "Sous — Your AI kitchen co-pilot" },
      {
        property: "og:description",
        content:
          "Calm, capable cooking help. Recipes from your fridge, gentle live guidance, and smarter grocery swaps.",
      },
    ...
    <header className="sticky top-0 z-40 border-b border-earth-200/60 bg-canvas/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-5 md:px-8">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="font-serif text-2xl leading-none">Sous</span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          >
            Open Sous <ArrowRight className="size-3.5" />
          </Link>
        </div>
      </div>
    </header>
      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 px-5 py-16 md:grid-cols-[1.05fr_1fr] md:gap-10 md:px-8 md:py-24 lg:py-32">
        <div className="space-y-7">
          ...
          <p className="max-w-[52ch] text-pretty text-base leading-relaxed text-earth-700 md:text-lg">
            Sous is a calm AI coach for your kitchen. It sees what you have, guides
            you through the cook with gentle real-time tips, and helps you spend less
            at the grocery store — without ever making you feel watched.
          </p>
  ...
  const steps = [
    {
      ...
      body: "Snap your fridge or tap a few items. Sous figures out what you can realistically make tonight.",
      mock: <SetupMock />,
    },
    {
      n: "02",
      title: "Cook with a calm coach",
      body: "Point your camera at the pan. Sous nudges in the moment — heat down, garlic ready, sauce glossy.",
      mock: <CameraMock />,
    },
    {
      n: "03",
...
const features = [
  {
    ...
    body: "Sous looks at your pantry photos and the chips you've tapped, then suggests something doable — not aspirational. Always with a realistic time and skill level.",
  ...
  },
  {
    ...
    body: "Sous watches the pan with you and offers quiet, well-timed nudges. No popups, no lectures — just the small note you wish someone had said.",
  ...
  },
  {
    ...
    body: "Wins first. One thing to try next time. No streaks, no shame. Sous tracks the skill, not the calories.",
    bullets: ["Wins & gentle 'to try' notes", "Skill tree progress", "Explainable — every tip cites why"],
    mock: <FeedbackMockLarge />,
  },
  {
    eyebrow: "Smarter grocery help",
    title: "Cook well, spend less.",
    body: "Pine nuts for $9? Try toasted sunflower seeds. Sous suggests honest swaps and flags what's on sale nearby — no upsells, no affiliate noise.",
  ...
  },
  {
    ...
    body: "Each session feeds a quiet skill tree. You'll feel sauté, knife work, and seasoning move from 'shaky' to 'second nature' — without a single notification chasing you.",
...
const beats = [
  { time: "6:42 PM", title: "Opens the app, tired.", body: "Sous greets her by name. 'What do you have on hand?'" },
  { time: "6:43 PM", title: "Snaps the fridge.", body: "Three photos. Sous identifies pasta, garlic, half a lemon, parmesan, wilted spinach." },
...
function Journey() {
  return (
    <Section eyebrow="A Tuesday with Sous" title="A small story.">
...
const trust = [
  ...
  },
  {
    ...
    body: "Sous suggests, never scolds. No streaks, no shame, no leaderboard.",
  },
  {
    icon: Shield,
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-20 md:px-8 md:py-28">
        <header className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-base leading-relaxed text-earth-700">
            An AI that helps you cook should also know when to stay quiet. Sous is
...
const faqs = [
  ...
  },
  {
    ...
    a: "No. Sous runs on any modern Android or iOS phone with a rear camera. A tripod or phone stand helps, but isn't required.",
  },
  {
    q: "Will this cost money?",
    a: "Sous is free during beta. We'll always keep a generous free tier; paid plans (if any) will unlock advanced skills, not basic guidance.",
  },
  {
        ...
        <div className="grid items-center gap-10 md:grid-cols-[1.2fr_1fr]">
          <div className="space-y-5">
            ...
            <p className="max-w-[44ch] text-base leading-relaxed text-earth-700">
              Open Sous, snap your fridge, and let a calm coach help you build real,
          ...
          >
            ...
            <p className="mt-1 font-serif text-xl leading-snug">
              We'll email you when Sous lands on Android.
            </p>
    ...
    <footer className="border-t border-earth-200/60">
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-5 py-12 md:grid-cols-4 md:px-8">
        <div className="md:col-span-2">
          ...
          <p className="mt-3 max-w-sm text-sm leading-relaxed text-earth-600">
            A calm AI coach for the kitchen — and, one day, for every small skill
      ...
      <div className="border-t border-earth-200/60">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center justify-between gap-2 px-5 py-6 text-[12px] text-earth-600 md:flex-row md:px-8">
          <p>© {new Date().getFullYear()} Sous Labs. Made with care.</p>
    ...
    <div className="overflow-hidden rounded-[28px] bg-white ring-1 ring-black/5">
      ...
      <div className="space-y-3 p-5">
        ...
        <div className="grid grid-cols-3 gap-2 rounded-2xl bg-earth-100/70 p-3 ring-1 ring-black/5">
          ...
          <MiniMeta icon={ChefHat} label="Sauté" />
        </div>
        <div className="flex flex-wrap gap-1.5">
  ...
  return (
    <div className="relative aspect-[4/5] overflow-hidden rounded-[28px] bg-earth-950 shadow-xl ring-1 ring-black/10">
      ...
      <div className="absolute left-1/2 top-5 -translate-x-1/2 rounded-full bg-black/30 px-3 py-1.5 ring-1 ring-white/10 backdrop-blur">
        <p className="text-[11px] font-medium text-white">Step 4 · Sauté the garlic</p>
      </div>
      ...
      <div className="absolute inset-x-4 bottom-4 space-y-2.5">
        <div className="flex gap-2.5 rounded-[20px] bg-white/95 p-3.5 shadow-xl ring-1 ring-black/5 backdrop-blur">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-[13px] leading-snug">Garlic is looking golden — ease the heat down.</p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-3 rounded-[28px] bg-white p-6 ring-1 ring-black/5">
      ...
      <div className="flex items-center gap-2 rounded-2xl bg-earth-100/70 p-3 text-[11px]">
        ...
        <span className="text-earth-700">Skill +1 · <span className="font-semibold">Sauté</span></span>
      </div>
    </div>
  );
}
